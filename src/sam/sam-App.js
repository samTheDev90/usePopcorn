    ...
    function () {
      ...
      async function fetchMovies() {
        try {
          ...
          if (!res.ok)
            throw new Error("Something went wrong , couldn't get movies data");
...
function MoviedDetails({ selectedId, onclosemovie, onAddWatch, watched }) {
...
function WachedMoviesList({ watched, onDeleteWatch }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <>
